    ...
    <div class="w-full max-w-3xl ml-0 space-y-3">
        <?php foreach ($tasks as $task): ?>
            <div class="border border-gray-200 dark:border-gray-800 rounded-xl overflow-hidden bg-white dark:bg-gray-900">
                ...
                <!-- DETAILS -->
                <div class="task-content max-h-0 opacity-0 overflow-hidden transition-all duration-500 ease-in-out w-full">
                    <div class="text-gray-600 dark:text-gray-300 p-4 md:p-5 text-sm md:text-base wrap-break-word whitespace-normal overflow-x-auto">
                        <div class="ql-editor w-65 md:w-full min-w-0 md:max-w-full"><?= $task['task_details'] ?></div>
                    </div>
                </div>
